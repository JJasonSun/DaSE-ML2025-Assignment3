...
```bash
export STUDENT_ID='51285903002'
export STUDENT_NAME='孙佳杰'
export STUDENT_NICKNAME='JJason'
...
```powershell
$env:STUDENT_ID="51285903002"
$env:STUDENT_NAME="孙佳杰"
$env:STUDENT_NICKNAME="JJason"
$env:MAIN_CONTRIBUTOR="AI"
```

### 3\. 运行评测

**本次作业仅在水杉平台提交，请不要在本地提交**
